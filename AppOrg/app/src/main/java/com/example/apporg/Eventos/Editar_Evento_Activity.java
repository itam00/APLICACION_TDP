...
public class Editar_Evento_Activity extends Agregar_Evento_Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] campos= {Utilidades.CAMPO_NOMBRE,Utilidades.CAMPO_DESCRIPCION,Utilidades.CAMPO_HORADESDE};
        ...
        try{
            ...
            if(cursor !=null && cursor.moveToFirst()) {
                ...
                etDescripcionEvento.setText(cursor.getString(1));
                etHoraDesde.setText(cursor.getString(2));
            }
            else{
